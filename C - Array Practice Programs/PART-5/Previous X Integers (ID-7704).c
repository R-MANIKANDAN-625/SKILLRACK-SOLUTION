...
The program must accept N integers as the input. The program must print the current integer and previous X integers for the each of the N
integers where X is the unit digit value of the current integer. 

Note: The first integer has no previous integer. So print only the first integer as the output. If there are no X previous integers then print only the available integers.
