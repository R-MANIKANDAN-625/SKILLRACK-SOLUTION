/*Group by Same Elements 

The program must accept N integers as the input. The program must group the same elements together in the given order and print it as the output.
...
Input:
9
10 5 2 5 10 1 16 1 10

Output:
10 10 10 5 5 2 1 1 16    */
